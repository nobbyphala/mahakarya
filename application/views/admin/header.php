...
<head>
    ...
    <link href="<?php echo base_url();?>assets/admin/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
	 ...
	 <!-- Link CK Editor-->
   	<script type="text/javascript" src="http://chernival.com/assets/ckeditor/ckeditor.js"></script>
	<script type="text/javascript" src="http://chernival.com/assets/ckeditor/style.js"></script>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="<?php echo base_url();?>admin/tambah_prestasi"><i class="fa fa-fw fa-trophy"></i> Prestasi</a>
                    </li>
                     <li>
                        <a href="<?php echo base_url();?>admin/tambah_pkm"><i class="fa fa-fw fa-trophy"></i> PKM</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url();?>admin/tambah_pkm"><i class="fa fa-fw fa-trophy"></i> List Dosbing</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url();?>admin/tambah_pkm"><i class="fa fa-fw fa-trophy"></i> List Mahasiswa</a>
                    </li>
					<li>
